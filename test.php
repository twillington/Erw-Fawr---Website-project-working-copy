...
<div id="wrapper">			
			...
			<div id="banner">
			<img src="images/rockmountains.jpg" height="463" width="900"/> 
			</div>
			<div id="subbanner" style="width: 99%">
				<h3 style="width: 869px"> Contacts</h3>
			</div>
			<div id="content">
